...
<aside class:sidebar--open={open} class="sidebar" id="wiki-navigation">
	<nav aria-label="Wiki navigation">
		...
		<a class:active={page.url.pathname === '/'} class="sidebar__home" href="/" onclick={onNavigate} aria-current={page.url.pathname === '/' ? 'page' : undefined}>
		...
		<NavTree items={navigation} pathname={page.url.pathname} {onNavigate} />
	</nav>
